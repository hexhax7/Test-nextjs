...
<Menu/>
  ...
  <section className="flex_container" >
    ...
    <motion.div initial={{ opacity: 0 }} transition={{duration: 1.0}} whileInView={{ opacity: 1 }} >
      ...
      <p> With over 20 years of experience transforming homes in london , Our team is committed to delivering exceptional renovations and extensions, fueled by our deep knowledge and expertise. We are driven by a passion for design, constantly seeking out innovative solutions to create unique spaces. <br />
